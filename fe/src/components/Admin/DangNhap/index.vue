                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-row mb-3 text-center justify-content-center mt-3">
                        <div class="p-2"><button class="btn"
                                style="background-color: cornflowerblue; border-radius: 100px;"><i
                                    class="fa-brands fa-google" style="color: #ffffff;"></i><b
                                    class="text-white ms-2">Google</b></button>
                        </div>
                        <div class="p-2"><button class="btn text-center btn-outline-white"
                                style="border-radius: 100px;"><i class="fa-brands fa-facebook-f"
                                    style="color: cornflowerblue;"></i></button></div>
                        <div class="p-2"><button class="btn text-center btn-outline-white"
                                style="border-radius: 100px;"><i class="fa-brands fa-twitter"
                                    style="color: cornflowerblue;"></i></button></div>
                    </div>
